...
if dsetIndex == 1
    dstpath = sprintf('%s/corbs-cabinet2/%s', rootfolder, subfolder);
elseif dsetIndex == 2
    dstpath = sprintf('%s/corbs-desk2/%s', rootfolder, subfolder);
elseif dsetIndex == 3
    dstpath = sprintf('%s/corbs-human2/%s', rootfolder, subfolder);
elseif dsetIndex == 4
