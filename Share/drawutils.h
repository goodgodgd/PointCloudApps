...
public:
    ...
    static void DrawPointCloud(int viewOption, cl_float4* pointCloud, cl_float4* normalCloud, QImage colorImg, cl_float4* descriptorCloud, QColor* qcolor, int planeNum, int* planeMap);
